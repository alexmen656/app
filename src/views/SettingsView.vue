  ...
  <div class="settings-view" @touchstart="handleTouchStart" @touchmove="handleTouchMove" @touchend="handleTouchEnd">
    ...
    <div class="settings-section">
      ...
      <div class="settings-card">
        ...
        <div class="setting-item">
          <a class="setting-link" href="https://www.kalbuddy.com/privacy-policy" target="_blank" rel="noopener">{{
    ...
    <div class="settings-section">
      ...
      <div class="settings-card">
        ...
        <div class="setting-item">
          ...
          <span class="setting-value build-clickable" @click="handleBuildClick">2025.09.007</span>
        </div>
